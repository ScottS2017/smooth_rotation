...
class SmoothRotationBuilder extends StatefulWidget {
  ...
  static Widget scaleBuilder(BuildContext context, Widget child, double angle) {
    ...
    final width =
        (media.size.width * sin(_rad90 - angle).abs()) + (media.size.height * sin(angle).abs());
    final height =
        (media.size.height * sin(_rad90 - angle).abs()) + (media.size.width * sin(angle).abs());
    return OverflowBox(
      minWidth: width,
      maxWidth: width,
      minHeight: height,
...
class _SmoothRotationBuilderState extends State<SmoothRotationBuilder> {
  @override
  Widget build(BuildContext context) =>
  // Null issue? Check that SmoothRotation is being initialized properly.
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Align(
                        alignment: Alignment.bottomCenter,
                        child: Text('Miroslav Vitula', style: theme.textTheme.headlineMedium),
                      ),
                      Align(
                        alignment: Alignment.bottomCenter,
                        child: Row(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Text('Some 3D stuff I\'ve been working on in AE.\nLooking all fresh!'),
          ),
          Row(
            children: <Widget>[
              Expanded(
